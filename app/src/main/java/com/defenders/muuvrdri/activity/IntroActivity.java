...
import com.defenders.muuvrdri.utils.AppIntroPagerAdapter;
import com.defenders.muuvrdri.utils.ProjectUtils;
import com.defenders.muuvrdri.utils.SharedPrefrence;
...
public class IntroActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    Button buttonSign;
    int[] mResources = {R.drawable.slide_1, R.drawable.slide_3, R.drawable.slide_2};
