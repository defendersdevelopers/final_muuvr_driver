...
public class FullImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fullpath = new File(Environment.getExternalStorageDirectory() + "/muuvr/" + chat_id + ".jpg");
        ...
        File direct = new File(Environment.getExternalStorageDirectory() + "/muuvr/");
    ...
    private void Savepicture(final boolean isfromshare) {
        if (Checkstoragepermision()) {
            ...
            final File direct = new File(Environment.getExternalStorageDirectory() + "/DCIM/muuvr/");
            progressDialog.show();
